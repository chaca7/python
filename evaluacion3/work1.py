...
class Ventana():
    def __init__(self):
        ...
        Label(self.ventana, text = "Lista de localidades").grid(pady=10, row=0, column=0)
    ...
    class Tabla():
        ...
        def carga_tabla(self, localidad):
            self.tabla = Entry(self.num_fila, width=20, fg='black', font=('Arial',10,'bold'))
